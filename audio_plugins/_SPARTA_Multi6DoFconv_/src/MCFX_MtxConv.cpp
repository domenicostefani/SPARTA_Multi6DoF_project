...
{
    // Hack to conform to JUCE 6 (MCFX uses Juce 7)
    #define juce_Thread_Priority_highest 2 
    // start a thread for each partitionsize
    startThread(juce_Thread_Priority_highest); // TODO: go back to juce::Thread::Priority::highest if updating to JUCE 7
}
